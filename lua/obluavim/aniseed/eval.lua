...
local a, compile, fennel, fs, nvim = autoload("obluavim.aniseed.core"), autoload("obluavim.aniseed.compile"), autoload("obluavim.aniseed.fennel"), autoload("obluavim.aniseed.fs"), autoload("obluavim.aniseed.nvim")
