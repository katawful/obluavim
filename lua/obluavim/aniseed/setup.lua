...
local _2amodule_name_2a = "obluavim.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("obluavim.aniseed.core"), autoload("obluavim.aniseed.env"), autoload("obluavim.aniseed.eval"), autoload("obluavim.aniseed.nvim")
