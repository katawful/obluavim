...
local _1_
do
  local name_4_auto = "obluavim.aniseed.env"
  local module_5_auto
  do
...
local function _6_(...)
  ...
  local function _5_()
    return {autoload("obluavim.aniseed.compile"), autoload("obluavim.aniseed.fennel"), autoload("obluavim.aniseed.fs"), autoload("obluavim.aniseed.nvim")}
  end
  ok_3f_21_auto, val_22_auto = pcall(_5_)
  if ok_3f_21_auto then
    _1_["aniseed/local-fns"] = {autoload = {compile = "obluavim.aniseed.compile", fennel = "obluavim.aniseed.fennel", fs = "obluavim.aniseed.fs", nvim = "obluavim.aniseed.nvim"}}
    return val_22_auto
  else
...
local _2amodule_name_2a = "obluavim.aniseed.env"
