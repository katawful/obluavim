package.preload["obluavim.aniseed.fennel.repl"] = package.preload["obluavim.aniseed.fennel.repl"] or function(...)
  local utils = require("obluavim.aniseed.fennel.utils")
  local parser = require("obluavim.aniseed.fennel.parser")
  local compiler = require("obluavim.aniseed.fennel.compiler")
  local specials = require("obluavim.aniseed.fennel.specials")
  local view = require("obluavim.aniseed.fennel.view")
...
package.preload["obluavim.aniseed.fennel.specials"] = package.preload["obluavim.aniseed.fennel.specials"] or function(...)
  local utils = require("obluavim.aniseed.fennel.utils")
  local view = require("obluavim.aniseed.fennel.view")
  local parser = require("obluavim.aniseed.fennel.parser")
  local compiler = require("obluavim.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "obluavim.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["obluavim.aniseed.fennel.compiler"] = package.preload["obluavim.aniseed.fennel.compiler"] or function(...)
  local utils = require("obluavim.aniseed.fennel.utils")
  local parser = require("obluavim.aniseed.fennel.parser")
  local friend = require("obluavim.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["obluavim.aniseed.fennel.friend"] = package.preload["obluavim.aniseed.fennel.friend"] or function(...)
  local utils = require("obluavim.aniseed.fennel.utils")
...
package.preload["obluavim.aniseed.fennel.parser"] = package.preload["obluavim.aniseed.fennel.parser"] or function(...)
  local utils = require("obluavim.aniseed.fennel.utils")
  local friend = require("obluavim.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["obluavim.aniseed.fennel.view"] = package.preload["obluavim.aniseed.fennel.view"] or function(...)
...
package.preload["obluavim.aniseed.fennel.utils"] = package.preload["obluavim.aniseed.fennel.utils"] or function(...)
  local view = require("obluavim.aniseed.fennel.view")
...
utils = require("obluavim.aniseed.fennel.utils")
local parser = require("obluavim.aniseed.fennel.parser")
local compiler = require("obluavim.aniseed.fennel.compiler")
local specials = require("obluavim.aniseed.fennel.specials")
local repl = require("obluavim.aniseed.fennel.repl")
local view = require("obluavim.aniseed.fennel.view")
...
do
  ...
  local module_name = "obluavim.aniseed.fennel.macros"
  local _
